...
export const nativeMapChromeStyles = StyleSheet.create({
  ...
  routePlannerTitle: { fontSize: 14, fontWeight: "800" as const },
  routePlannerGo: {
    marginHorizontal: 12,
    marginBottom: 10,
    paddingVertical: 12,
  ...
  routePlannerGoText: { color: "#fff", fontWeight: "800" as const, fontSize: 14 },
  routePlannerHint: { fontSize: 11, marginHorizontal: 12, marginBottom: 8, lineHeight: 15 },
});
