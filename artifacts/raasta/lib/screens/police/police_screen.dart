...
class _PoliceScreenState extends State<PoliceScreen>
  ...
  void _addVip(BuildContext context) {
    ...
    String vipLevel = 'Federal Minister';
    double lat = 33.6844;
    double lng = 73.0479;
                    ...
                    return ElevatedButton(
                      onPressed: posting
                          ...
                          : () async {
                              ...
                              btnSs(() => posting = true);
                              try {
                                await context.read<PoliceProvider>().addAlert(
                                  PoliceAlert(
                                    id: 'pa${DateTime.now().millisecondsSinceEpoch}',
                                    type: PoliceAlertType.vipMovement,
                                    title: titleCtrl.text,
                                    description: descCtrl.text,
                                    route: routeCtrl.text,
                                    startPoint: startCtrl.text,
                                    endPoint: endCtrl.text,
                                    affectedRoads: [routeCtrl.text],
                                    alternateRoutes: ['See alternate routes'],
                                    severity: 'High',
                                    vipLevel: vipLevel,
                                    isActive: true,
                                    createdAt: DateTime.now(),
                                    createdBy: 'Police Officer',
                                    lat: lat,
                                    lng: lng,
                                  ),
                                );
                  ...
                  builder: (ctx, btnSs) {
                    ...
                    return ElevatedButton(
                          ...
                          : () async {
                              ...
                              try {
                                await context.read<PoliceProvider>().addAlert(
                                  PoliceAlert(
                                    id: 'pa${DateTime.now().millisecondsSinceEpoch}',
                                    type: PoliceAlertType.roadBlockage,
                                    title: titleCtrl.text,
                                    description: descCtrl.text,
                                    route:
                                    ...
                                    startPoint: startCtrl.text,
                                    endPoint: endCtrl.text,
                                    affectedRoads: [startCtrl.text],
                                    alternateRoutes: [altCtrl.text],
                                    severity: severity,
                                    vipLevel: 'N/A',
                                    isActive: true,
                                    createdAt: DateTime.now(),
                      ...
                      child: posting
                          ...
                          : const Text('Post Blockage Alert'),
                    );
                  },
                ),
                const SizedBox(height: 16),
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(
                    alert.type == PoliceAlertType.vipMovement
                        ? Icons.security
                        : Icons.block,
                    color: color,
                    size: 20,
              ...
              child: Column(
                ...
                children: [
                  ...
                  _routeRow(
                    Icons.alt_route,
                    'Alternate',
                    alert.alternateRoutes.take(2).join(', '),
                  ),
                ],
              ),
            ),
            if (alert.isActive) ...[
              ...
              Align(
                ...
                child: TextButton.icon(
                  onPressed: () async {
                    try {
                      await context.read<PoliceProvider>().clearAlert(alert.id);
                    } catch (e) {
                      if (context.mounted) {
