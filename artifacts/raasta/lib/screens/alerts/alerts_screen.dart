      ...
      builder: (context, provider, _) {
        ...
        return Scaffold(
                ...
                Expanded(
                  child: alerts.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (ctx, i) =>
                              _AlertCard(alert: alerts[i], index: i),
                        ),
                ),
              ],
            ),
          ...
          floatingActionButton: Padding(
            ...
            child: _ReportFAB(onPressed: () => _showReport(context, provider)),
          ),
        );
      },
    );
        ...
        background: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFF6A0000), Color(0xFFD32F2F)],
        ...
        child: Container(
          ...
          child: Column(
            children: [
              _FilterRow(
                options: _severities,
                selected: provider.selectedSeverity,
                onSelect: provider.setSeverity,
              ),
              _FilterRow(
                options: _cities,
                selected: provider.selectedCity,
                onSelect: provider.setCity,
              ),
            ],
          ),
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                RaastTextField(
                  ...
                  hintText: 'e.g. Road blocked at Faiz Ahmed Faiz',
                ),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(
              colors: [Color(0xFF9A0007), Color(0xFFD32F2F)],
              begin: Alignment.topLeft,
              end: Alignment.bottomRight,
            ),
            borderRadius: BorderRadius.circular(20),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Spacer(),
                      Text(
                        _expanded ? 'Tap to collapse' : 'Tap for details',
                        style: TextStyle(
                          fontSize: 11,
        ...
        items: items
            .map(
              (s) => DropdownMenuItem<T>(
                value: s,
                child: Text(s.toString(), style: const TextStyle(fontSize: 14)),
              ),
            )
            .toList(),
        onChanged: onChanged,
